"""전투 로봇 / 20260919 / 체감 난이도: G4
소요 시간 27분 / 시도 1회 / 실행 시간 54ms (코드트리) / 메모리 17MB (코드트리)

아마 이 문제 처음 풀면서 반성 많이 하고 스타일을 바꿔보려는 노력을 많이 했던 것 같다.
돌이켜보면 참으로 고마운 문제. 겉멋 다 빼고, 조기 종료 추가해서 풀어봤다.
"""
